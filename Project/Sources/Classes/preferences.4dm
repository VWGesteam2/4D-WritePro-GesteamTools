...
Class constructor()
	...
	This:C1470._user:=Folder:C1567(fk dossier préférence utilisateur:K87:10).folder(Folder:C1567(Dossier base:K5:14; *).name)
	This:C1470._database:=Folder:C1567(fk dossier base de données:K87:14; *).folder("Preferences")
	This:C1470._session:=Folder:C1567(fk dossier bureau:K87:19).parent.folder("Library/Preferences/")
