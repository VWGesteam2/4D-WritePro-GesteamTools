	...
	If ($isTable=True:C214)
		...
		Case of 
			: ($applyTo="table")
				...
				APPEND MENU ITEM:C411($menu; ak standard action title:K76:83)
				SET MENU ITEM PROPERTY:C973($menu; -1; Action standard associée:K56:1; "headerRowCount")  //a remplacer par constante
				
				APPEND MENU ITEM:C411($menu; ak standard action title:K76:83)
				SET MENU ITEM PROPERTY:C973($menu; -1; Action standard associée:K56:1; "bottomCarryOverRow")  //a remplacer par constante
		...
		Case of 
			: ($choice="SetDatasource")
				...
				//WP LIRE ATTRIBUTS($wpTable; ‘k81;367‘; $formula)
				...
				If (Is table number valid:C999($i))
					...
					If (ok=1)
						If ($formulaText#"")
							...
							//WP FIXER ATTRIBUTS($wpTable; ‘k81;367‘; $formula)
						Else 
							//WP RÉINITIALISER ATTRIBUTS($wpTable; ‘k81;367‘)
						End if 
					End if 
