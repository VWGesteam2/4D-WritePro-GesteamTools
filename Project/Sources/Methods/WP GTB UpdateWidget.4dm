...
Case of 
	...
	: (Count parameters:C259>=2)
		...
		If ($typeWidget=Est un objet:K8:27) & ($typeArea=Est un objet:K8:27) & (Not:C34(OB Is empty:C1297($oArea)))
			...
			Case of 
				: (Form event code:C388=Sur perte focus:K2:8) | (Form event code:C388=Sur chargement:K2:1)
